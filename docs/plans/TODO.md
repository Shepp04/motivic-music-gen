...
* Disable inversions + extensions (on the tonic) from cadences
...
ISSUES
* melody infilling after cadence
...
MVP FEATURES
* Render in musescore 4 [D]
* Set certain instrument combos [C]
* Vary the accompaniment with alberti bass, arpeggiation, block chords [B]
* Make cadences robust [A]
